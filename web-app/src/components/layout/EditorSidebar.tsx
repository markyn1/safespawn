...
import { LayoutGrid, Blocks, Heart, Settings, Search } from "lucide-react";
...
export function EditorSidebar({ activeResolution, onSelectTemplate }: EditorSidebarProps) {
    ...
    return (
        ...
        <aside className="w-[280px] shrink-0 flex flex-col border-r border-border bg-card text-card-foreground">
            <Tabs defaultValue="modelos" className="flex flex-col flex-1 min-h-0">
                <TabsList className="w-full justify-start rounded-none border-b border-border bg-transparent p-0 h-12 gap-0">
                    <TabsTrigger
                        value="modelos"
                        className={cn(
                            "rounded-none border-b-2 border-transparent data-[state=active]:border-emerald-500 data-[state=active]:bg-transparent data-[state=active]:text-emerald-500 data-[state=active]:shadow-none gap-2 px-4 h-12"
                        )}
                    >
                    ...
                    <TabsTrigger
                        value="blocos"
                        className="rounded-none border-b-2 border-transparent data-[state=active]:border-emerald-500 data-[state=active]:bg-transparent data-[state=active]:text-emerald-500 data-[state=active]:shadow-none gap-2 px-4 h-12"
                    >
                ...
                <TabsContent value="modelos" className="flex-1 flex flex-col min-h-0 mt-0 p-4">
                ...
                <TabsContent value="blocos" className="flex-1 min-h-0 mt-0 p-4">
                    <p className="text-sm text-muted-foreground">Blocos em breve.</p>
                </TabsContent>
                ...
                <TabsContent value="geral" className="flex-1 min-h-0 mt-0 p-4">
                    <p className="text-sm text-muted-foreground">Configurações gerais (cor de fundo, etc.) em breve.</p>
                </TabsContent>
            </Tabs>
        </aside>
        </TooltipProvider>
